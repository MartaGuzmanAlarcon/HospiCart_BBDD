...
public class MainMenu {
	        ...
	        try {
	        	switch (input) {
		            ...
		            case 0:
		                ...
		                //If the user introduces a 0, then we set the variable "exit" to true so we can exit the switch.
		                keepGoing = false;
		                System.exit(0); //We include this line to temrinate the running application
		                break;
		            default:
		            	Output.println("The number introduced is invalid. Please try again introducing a number that corresponds with one operation of the shown below: ");
		            	break;
    	...
    	if(!loggedIn) {
	        ...
	        while (keepGoing) {
	            ...
	            if (user != null) {
	            	...
	            	Output.println("Incorrect email, incorrect password or user not registered.");
    ...
    public static void resetPassword() throws IOException{
    	...
    	Output.println("Did you forget your password?");
    	...
    	while(keepGoing) {
    		...
    		if(tryAgain && user == null) {
    			Output.println("Please introduce your email: ");
    			String email = InputKB.readString();
        	...
        	if(user == null) {
        		Output.println("The introduced email does not have an account asociated to it.");
